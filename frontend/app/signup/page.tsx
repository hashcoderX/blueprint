          ...
          <div className="p-4 sm:p-8 md:px-16 md:py-12">
            ...
            <div className="mb-6">
              <button
                ...
                className="w-full flex items-center justify-center px-4 py-3 bg-white dark:bg-powerbi-gray-700 border border-powerbi-gray-300 dark:border-powerbi-gray-600 rounded-xl hover:bg-powerbi-gray-50 dark:hover:bg-powerbi-gray-600 transition-all duration-200 transform hover:scale-105 shadow-sm"
              >
                ...
                <span className="text-sm font-medium text-powerbi-gray-700 dark:text-powerbi-gray-300">Sign in with Google</span>
              </button>
