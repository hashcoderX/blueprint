        ...
        <div className="flex flex-wrap justify-between items-start sm:items-center gap-4">
          ...
          <div className="flex gap-3 w-full sm:w-auto">
            <button
              ...
              className="flex items-center px-4 py-2 rounded-lg bg-blue-600 hover:bg-blue-700 text-white font-medium w-full sm:w-auto shrink-0"
            >
            ...
            <button
              ...
              className="flex items-center px-4 py-2 rounded-lg bg-emerald-600 hover:bg-emerald-700 text-white font-medium w-full sm:w-auto shrink-0"
            >
              <Plus className="w-4 h-4 mr-2" />
              Add Expense
            </button>
          ...
          <div className="bg-gradient-to-br from-emerald-400 to-emerald-600 rounded-2xl p-6 text-white">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl sm:text-3xl font-bold">{totalSales}</p>
              </div>
          ...
          <div className="bg-gradient-to-br from-purple-400 to-purple-600 rounded-2xl p-6 text-white">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl sm:text-3xl font-bold">{new Intl.NumberFormat(undefined, { style: 'currency', currency: userProfile?.currency || 'USD' }).format(monthProfit)}</p>
              </div>
              ...
              <table className="w-full">
                <thead className="bg-powerbi-gray-50 dark:bg-powerbi-gray-900/50">
                  <tr>
                    ...
                    <th className="px-3 py-2 sm:px-6 sm:py-3 text-left text-xs font-medium text-powerbi-gray-500 dark:text-powerbi-gray-400 uppercase tracking-wider">Gem</th>
                    <th className="px-3 py-2 sm:px-6 sm:py-3 text-left text-xs font-medium text-powerbi-gray-500 dark:text-powerbi-gray-400 uppercase tracking-wider">Weight</th>
                    <th className="px-3 py-2 sm:px-6 sm:py-3 text-left text-xs font-medium text-powerbi-gray-500 dark:text-powerbi-gray-400 uppercase tracking-wider">Buyer</th>
                    ...
                    <th className="px-3 py-2 sm:px-6 sm:py-3 text-left text-xs font-medium text-powerbi-gray-500 dark:text-powerbi-gray-400 uppercase tracking-wider">Cost</th>
                    <th className="px-3 py-2 sm:px-6 sm:py-3 text-left text-xs font-medium text-powerbi-gray-500 dark:text-powerbi-gray-400 uppercase tracking-wider">Profit/Loss</th>
                    <th className="px-3 py-2 sm:px-6 sm:py-3 text-left text-xs font-medium text-powerbi-gray-500 dark:text-powerbi-gray-400 uppercase tracking-wider">P/L %</th>
                ...
                <tbody className="bg-white dark:bg-powerbi-gray-800 divide-y divide-powerbi-gray-200 dark:divide-powerbi-gray-700">
                  {sales.map(s => (
                    <tr key={s.id} className="hover:bg-powerbi-gray-50 dark:hover:bg-powerbi-gray-900/50 cursor-pointer" onClick={() => { setSelectedSale(s); setShowDetail(true); }}>
                      <td className="px-3 py-3 sm:px-6 sm:py-4 whitespace-nowrap text-sm text-powerbi-gray-900 dark:text-white">{new Date(s.date).toLocaleDateString()}</td>
                      <td className="px-3 py-3 sm:px-6 sm:py-4 text-sm text-powerbi-gray-900 dark:text-white font-medium">{s.gem_name || '-'}</td>
                      <td className="px-3 py-3 sm:px-6 sm:py-4 text-sm text-powerbi-gray-600 dark:text-powerbi-gray-400">{s.weight != null ? Number(s.weight).toFixed(3) : '-'}</td>
                      <td className="px-3 py-3 sm:px-6 sm:py-4 whitespace-nowrap text-sm text-powerbi-gray-600 dark:text-powerbi-gray-400">{s.buyer || '-'}</td>
                      <td className="px-3 py-3 sm:px-6 sm:py-4 whitespace-nowrap text-sm font-semibold text-blue-700 dark:text-blue-400">
                      ...
                      <td className="px-3 py-3 sm:px-6 sm:py-4 whitespace-nowrap text-sm font-semibold">
                        {(() => {
                          const cost = ((Number(s.purchase_price) || 0) + (Number(s.expenses_total) || 0));
